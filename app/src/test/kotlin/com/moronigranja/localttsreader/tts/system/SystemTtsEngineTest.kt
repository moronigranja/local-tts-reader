...
class SystemTtsEngineTest {
    ...
    @Test
    fun `audio outcome carries mono pcm and no segments`() = runTest {
    ...
    @Test
    fun `unavailable names the requested language`() = runTest {
    ...
    @Test
    fun `unavailable without a voice names the device default`() = runTest {
        val engine = SystemTtsEngine(FakeSeam(TtsSynthesis.Unavailable))
    ...
    @Test
    fun `empty pcm reads as failure`() = runTest {
    ...
    @Test
    fun `never throws - seam failure returns Failed`() = runTest {
    ...
    @Test
    fun `voice hint maps the kokoro family to the device language`() = runTest {
    ...
    private class FakeSeam(
        ...
        override suspend fun synthesizeToPcm(text: String, language: String?): TtsSynthesis {
