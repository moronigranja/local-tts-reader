...
/**
 * In-test EPUB builder for feature-library tests — a local mirror of
 * core-ebook's EpubFixture of the same name. (testFixtures reuse is not used:
 * core-ebook is a java-library without the java-test-fixtures plugin, so its
 * testFixtures variant is not published; a mirror keeps core-ebook untouched.)
 */
object EpubFixture {
