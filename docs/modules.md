...
core-backup/      LIVE — versioned v1 backup archive: codec + DTOs, export/import of library data (decisions #89); no Android deps
...
feature-library/  SAF import + library list UI (Compose, Hilt) — C5/C6; F2 title/author search + empty state (#90); library-row pre-gen action + usage/estimate/delete over PregenStorage (#42/#44)
