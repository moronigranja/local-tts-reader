...
| Translation decorator (any advertised target language) | Post-v1 — new `core-translate` marker (scope widened from pt-BR, 2026-08-31, decisions #101) |
